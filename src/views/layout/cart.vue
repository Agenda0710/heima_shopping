        ...
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          ...
          <div class="info">
            ...
            <span class="bottom">
              ...
              <div class="count-box">
                <!--  既希望保留原本的形参，又希望通过调用函数传参    -->
               <count-box :value="item.goods_num"
                          @input="(value) => changeCount(value,item.goods_id,item.goods_sku_id)"></count-box>
              </div>
            </span>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters('cart', ['cartTotal', 'selCount', 'selCartList', 'selPrice', 'isAllChecked'])
  },
  created() {
  ...
  methods: {
    ...
    handleDel() {
      ...
      this.$store.dispatch('cart/delSelect', this.selCartList)
    }
  }
}
</script>
